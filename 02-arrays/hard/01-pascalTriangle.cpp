// Problem Statement: Write a program to generate Pascal's triangle. In Pascal’s triangle, each
// number is the sum of the two numbers directly above it as shown in the figure below:
#include <bits/stdc++.h>
using namespace std;
