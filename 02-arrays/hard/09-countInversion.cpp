...
int numberOfInversions_opt(vector<int> &arr) {
    return merge_sort<int>(arr, 0, arr.size() - 1);
}

// Count inversions in an array
// Problem Statement: Given an array of N integers, count the inversion of the array (using
// merge-sort). What is an inversion of an array? Definition: for all i & j < size of array, if i <
